...
SELECT oficina.ciudad,oficina.telefono FROM oficina WHERE oficina.pais = 'España';
#3. Devuelve un listado con el nombre, apellidos y email de los empleados cuyo jefe tiene un código de jefe igual a 7.
SELECT empleado.nombre,empleado.apellido1,empleado.apellido2,empleado.email FROM empleado WHERE empleado.codigo_jefe = 7;
...
FROM 
		empleado 
WHERE 
		empleado.puesto NOT LIKE '%representante%';
...
FROM pedido;
#8. Devuelve un listado con el código de cliente de aquellos clientes que realizaron algún pago en 2008. Tenga en cuenta que deberá eliminar aquellos códigos de cliente que aparezcanrepetidos. Resuelva la consulta:
#o Utilizando la función YEAR de MySQL.
#o Utilizando la función DATE_FORMAT de MySQL.
#o Sin utilizar ninguna de las funciones anteriores.
SELECT DISTINCT pago.codigo_cliente
FROM pago 
...
SELECT pedido.codigo_pedido,pedido.codigo_cliente,pedido.fecha_esperada,pedido.fecha_entrega FROM pedido WHERE pedido.fecha_entrega > pedido.fecha_esperada;
